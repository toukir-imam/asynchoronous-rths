function agent = runStep(agent,errorRate)
...
if (isempty(fN))
    ...
    agent.energy=0;
    %exception = MException('runStep Line 37','this is not supposed to happen');
    %throw(exception); 
    fprintf('this is not supposed to happen\n');
    return
end
...
hN0 =getH(iN,agent.h0,errorRate); %change baack to h0
