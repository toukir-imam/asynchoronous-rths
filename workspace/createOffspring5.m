function [ agent ] = createOffspring5( id,problem,maps,p1Gene,p2Gene,mutationRate,geneMin,geneMax,energyMultipler)
...
%Energy
LRTAStarDifficulty = problem(problemId).LRTAStarDifficulty;
energy = hStar*LRTAStarDifficulty*energyMultipler;
if(energy <0)
    energy
    s = 'AAAAAAAAAAA'
    LRTAStarDifficulty
